...
func (lq *LinkQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (lq *LinkQuery) FirstIDX(ctx context.Context) uint {
...
func (lq *LinkQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (lq *LinkQuery) OnlyIDX(ctx context.Context) uint {
...
func (lq *LinkQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (lq *LinkQuery) IDsX(ctx context.Context) []uint {
	ids, err := lq.IDs(ctx)
	if err != nil {
		panic(err)
	}
